In TFS, the layout for a work item type is defined via XML. Therefore, you will have to add the fieldtext control to your layout. Here's the series of steps that tell you how to do it.
...
Extension:
	Name: vsts-extensions-fieldtext-control
	Id: ms-devlabs.vsts-extensions-fieldtext-control

	Control contribution:
		Id: ms-devlabs.vsts-extensions-fieldtext-control.fieldtext-form-control
...
```xml
        ...
        <Extensions>
            <Extension Id="ms-devlabs.vsts-extensions-fieldtext-control" />
        </Extensions>
     ```
...
4. Add the ControlContribution tag for your fieldtext control. This example adds it to the "Planning" group.
...
```xml
    ...
    ...
        ...
        ...
            <Group Id="Planning">
            ...
                <ControlContribution Label="Label" Id="ms-devlabs.vsts-extensions-fieldtext-control.fieldtext-form-control">
                    <Inputs>
